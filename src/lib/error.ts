...
const DEFAULT_ERROR_MESSAGE = `Desculpe, mas ocorreu um erro inesperado. Por favor, tente novamente mais tarde ou entre em contato com o suporte se o problema persistir.`
